...
void GameEngine::upgradeLumberMill() {
    if (GoldStorage != nullptr && StoneStorage != nullptr && WoodStorage != nullptr) {
        if ((GoldStorage->getStoredGold() + TownHall->getStoredGold()) - (110 * LumberMill->getBuildLevel()) >= 0 &&
            ...
            (WoodStorage->getStoredWood() + TownHall->getStoredWood()) - (70 * LumberMill->getBuildLevel()) >= 0 && LumberMill->getBuildLevel() < TownHall->getBuildLevel()) {
