...
void GameEngine::upgradeWoodStorage() {
    if (GoldStorage != nullptr && StoneStorage != nullptr && WoodStorage != nullptr) {
        if ((GoldStorage->getStoredGold() + TownHall->getStoredGold()) - (80 * WoodStorage->getBuildLevel()) >= 0 &&
            ...
            (WoodStorage->getStoredWood() + TownHall->getStoredWood()) - (80 * WoodStorage->getBuildLevel()) >= 0 && WoodStorage->getBuildLevel() < TownHall->getBuildLevel()) {
